...
public class ExperienceDisplayEntry extends DisplayEntry {
    ...
    public ExperienceDisplayEntry(EntityXPOrb orb) {
        this(new TextComponentString(orb.getName()), orb.xpValue);
    }

    private ExperienceDisplayEntry(ITextComponent name, int count) {
        super(name, count, EnumRarity.COMMON);
    }
    ...
    protected void renderSprite(Minecraft mc, int posX, int posY) {
        ...
        Gui.drawModalRectWithCustomSizedTexture(posX, posY, x, y, 16, 16, 64, 64);

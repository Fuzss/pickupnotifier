...
public class PickUpNotifier implements ModConstructor {
    ...
    private static void registerMessages() {
        NETWORK.registerClientbound(S2CTakeItemMessage.class, S2CTakeItemMessage::new);
        NETWORK.registerClientbound(S2CTakeItemStackMessage.class, S2CTakeItemStackMessage::new);
    }
}
